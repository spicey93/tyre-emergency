...
!(function (t, e) {
    ...
    (p.prototype = {
        ...
        _trunc: function () {
            return (
                (this.x = nt(this.x)), (this.y = nt(this.y)), this
            );
        },
        ...
        (f.prototype = {
            ...
            contains: function (t) {
                ...
                return (
                    (t = (
                        "number" == typeof t[0] || t instanceof p
                            ? m
                            : _
                    )(t)) instanceof f
                        ? ((e = t.min), (i = t.max))
        ...
        st = l({}, ot, {
            ...
            distance: function (t, e) {
                var i = Math.PI / 180,
                    ...
                    i =
                        2 *
                        Math.atan2(Math.sqrt(t), Math.sqrt(1 - t));
                return this.R * i;
            },
        }),
        rt = 6378137,
    ...
    var _t = document.documentElement.style,
        ...
        Ht = !(
            !document.createElementNS || !ct("svg").createSVGRect
        ),
        Wt =
            !!Ht &&
            (((Wt = document.createElement("div")).innerHTML =
                "<svg/>"),
                "http://www.w3.org/2000/svg" ===
        ...
        A = it.extend({
            ...
            zoomIn: function (t, e) {
                return (
                    (t =
                        t ||
                        (b.any3d ? this.options.zoomDelta : 1)),
            ...
            _getBoundsCenterZoom: function (t, e) {
                ...
                var i = m(e.paddingTopLeft || e.padding || [0, 0]),
                    n = m(
                        e.paddingBottomRight || e.padding || [0, 0],
                    ),
            ...
            _moveEnd: function (t) {
                return (
                    t && this.fire("zoomend"), this.fire("moveend")
                );
            },
            _stop: function () {
                return (
            ...
            _tryAnimatedZoom: function (t, e, i) {
                if (!this._animatingZoom) {
                    if (
                        ...
                        return !1;
                    var n = this.getZoomScale(e),
                        n = this._getCenterOffset(t)._divideBy(
                            1 - 1 / n,
                        );
                    if (
                        !0 !== i.animate &&
            ...
            _animateZoom: function (t, e, i, n) {
                this._mapPane &&
                    (i &&
                        ...
                        setTimeout(
                            a(this._onZoomTransitionEnd, this),
                            250,
                        ));
            },
    ...
    var B = et.extend({
        ...
        Ke = B.extend({
            ...
            setPrefix: function (t) {
                return (
                    (this.options.prefix = t), this._update(), this
                );
            },
    ...
    var vt = {
        ...
        di = et.extend({
            ...
            _createImg: function (t, e) {
                return (
                    ((e = e || document.createElement("img")).src =
                        t),
                    e
                );
            },
    ...
    var _i = di.extend({
        ...
        mi = o.extend({
            ...
            setZIndexOffset: function (t) {
                return (
                    (this.options.zIndexOffset = t), this.update()
                );
            },
            getIcon: function () {
        ...
        _project: function () {
            ...
            h.distance === st.distance
                ...
                : ((o = h.unproject(
                    ...
                    (this._point = a.latLngToLayerPoint(
                        this._latlng,
                    )),
                    (this._radius =
    ...
    var yi = fi.extend({
        ...
        _defaultShape: function () {
            return I(this._latlngs)
                ? this._latlngs
                : this._latlngs[0];
        },
        _convertLatLngs: function (t) {
            for (
                var e = [], i = I(t), n = 0, o = t.length;
                n < o;
                n++
            )
                i
        ...
        _clipPoints: function () {
            ...
            if (
                ...
                if (this.options.noClip) this._parts = this._rings;
                    ...
                    for (
                        var i, n = 0, o = this._rings.length;
                        n < o;
                        n++
                    )
            ...
            for (o = 0, a = this._parts.length; o < a; o++)
                for (
                    ...
                    (i = e[s]),
                        ...
                        (l = !l);
            return (
                l || yi.prototype._containsPoint.call(this, t, !0)
            );
        },
    });
    var wi = ci.extend({
    ...
    function Pi(t, e, i, n) {
        return t
            ? t(e, i)
            : new mi(i, n && n.markersInheritOptions && n);
    }
    function Li(t) {
    ...
    var Mt = Si,
        Ei = o.extend({
            ...
            setStyle: function (t) {
                return (
                    t.opacity && this.setOpacity(t.opacity), this
                );
            },
            bringToFront: function () {
            ...
            _initImage: function () {
                ...
                M(e, "leaflet-image-layer"),
                    this._zoomAnimated &&
                    M(e, "leaflet-zoom-animated"),
                    this.options.className &&
                    M(e, this.options.className),
                    (e.onselectstart = u),
                    (e.onmousemove = u),
                            ...
                            (this._map._panAnim &&
                                ...
                                this._autopanning
                                    ...
                                    : ((t = this._map),
                                        ...
                                        (e =
                                            this._container.offsetHeight + e),
            ...
            (A.mergeOptions({ closePopupOnClick: !0 }),
                A.include({
                    openPopup: function (t, e, i) {
                        return (
                            this._initOverlay(Bi, t, e, i).openOn(this),
                            this
                        );
                    },
        ...
        Ri =
            (A.include({
                openTooltip: function (t, e, i) {
                    return (
                        this._initOverlay(Ii, t, e, i).openOn(this),
                        this
                    );
                },
    ...
    var Hi = Di.extend({
        ...
        initialize: function (t, e) {
            ...
            var t =
                (e = c(this, e)).detectRetina && b.retina
                    ? 2
                    : 1,
                o = this.getTileSize();
            (n.width = o.x * t),
            ...
            _updateStyle: function (t) {
                ...
                (o.stroked = !!n.stroke),
                    ...
                    n.stroke
                        ...
                        : e &&
                        (o.removeChild(e), (t._stroke = null)),
                    n.fill
                        ? ((i = i || (t._fill = Vi("fill"))),
                            o.appendChild(i),
    ...
    b.vml && Gi.include(zt),
        A.include({
            ...
            _createRenderer: function (t) {
                return (
                    (this.options.preferCanvas && Ui(t)) || Ki(t)
                );
            },
        });
    var Yi = xi.extend({
        initialize: function (t, e) {
            xi.prototype.initialize.call(
                this,
                ...
                n.extend({
                    ...
                    _onTouchStart: function (t) {
                        ...
                        !t.touches ||
                            ...
                            n._animatingZoom ||
                            this._zooming ||
                            ((e = n.mouseEventToContainerPoint(
                                t.touches[0],
                            )),
...
var map = L.map("map").setView([53.07986, -0.81095], 11);
L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png", {
    maxZoom: 19,
    attribution:
        '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>',
}).addTo(map);
var marker = L.marker([53.07986, -0.81095]).addTo(map);
marker
    .bindPopup("<b>Mobile Tyre Fitting in Newark</b>")
    .openPopup();
